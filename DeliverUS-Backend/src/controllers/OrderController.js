...
const generateFilterWhereClauses = function (req) { // Hecho en clase
...
const indexRestaurant = async function (req, res) { // Hecho en clase
...
const show = async function (req, res) { // Hecho en clase
  try {
    const order = await Order.findByPk(req.params.orderId, {
      include: [{
        model: Restaurant,
